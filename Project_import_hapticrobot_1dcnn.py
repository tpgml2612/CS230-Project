...
from Project_notebook_hapticrobot_1dcnn import forward_fill_nan, pad_with_last_value, load_all_data, split_data, build_model, compile_and_train_model, evaluate_model, plot_training_history, plot_predictions, capture_model_summary, log_experiment, save_final_model
...
def main(timestamp,params):
    ...
    #Scale data
    x_scaler_path = os.path.join("results", "plots", f"x_scaler_2025-12-03_01-36-52.pkl")
    y_scaler_path = os.path.join("results", "plots", f"y_scaler_2025-12-03_01-36-52.pkl")
...
if __name__ == "__main__":
    for (timestamp,params) in [("20251203_095144",([64,64,64],[1,4,16],0,2,[32,64],4))]:
