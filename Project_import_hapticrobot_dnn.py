...
def main(timestamp,params):
    ...
    #Import data
    PROCESSED_DATA_FILE = "../CS230-Project/processed_hapticrobot_data.npy"
...
if __name__ == "__main__":
    for (timestamp,params) in [("20251110_110303",([128, 64, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32],0.005))]:
